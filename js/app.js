...
*/
    ...
    let textWrapper = document.querySelector(".hero__title");
    textWrapper.innerHTML = textWrapper.textContent.replace(/\S/g, "<span class='letter'>$&</span>");
    let anima = anime_es.timeline({
        loop: false
    });
    anima.add({
    ...
    function delayJs() {
        ...
        if (mediaQuery992.matches) {
            let offer = document.querySelector(".category");
            gsapWithCSS.from(offer.querySelectorAll(".category__offer"), {
                scrollTrigger: {
                    trigger: offer,
                    start: "300 center",
                    end: "+=0",
